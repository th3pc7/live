<div style="padding:40px;padding-bottom:0px;">
  <table class="table table-bordered" style="">
    ...
    <tbody>
      ...
      <tr style="color:<?php echo ($chanal['chanal_status']==='disabled') ? 'red' : 'green'; ?>;">
        <td>
          <a href="#" title="แก้ไขเวลา" class="glyphicon glyphicon-edit" onclick="edit_ch(event, <?php echo $chanal['chanal_id'] ?>, 'datetime', '<?php echo $chanal['datetime'] ?>')"></a><br>
          <?php echo $chanal['datetime']; ?>
        </td>
        <td>
